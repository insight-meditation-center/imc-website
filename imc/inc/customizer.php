<?php
/**
 * Insight Meditation Center Theme Customizer.
 *
...
function imc_customize_preview_js() {
	wp_enqueue_script( 'imc_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
